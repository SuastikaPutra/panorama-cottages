...
@section('content')
    ...
    <div class="container mb-5">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 mb-3">
                <picture>
                    <img src="{{ asset('assets/img/foto-1.jpg') }}" alt="Room 1" class="img-fluid rounded"
            ...
            <div class="col-md-4">
                ...
                <div class="d-none d-md-block" style="max-height: 500px; overflow-y: auto;">
                    <div class="mb-3">
                        <picture>
                            <img src="{{ asset('assets/img/foto-6.jpg') }}" alt="Tour Image" class="img-fluid rounded"
                        ...
                        <picture>
                            <img src="{{ asset('assets/img/foto-3.jpg') }}" alt="Tour Image" class="img-fluid rounded"
                                style="height: 200px; width: 100%; object-fit: cover;margin-bottom: 10px;" loading="lazy">
                        </picture>
                        <picture>
                            <img src="{{ asset('assets/img/foto-5.jpg') }}" alt="Tour Image" class="img-fluid rounded"
                                style="height: 200px; width: 100%; object-fit: cover;margin-bottom: 10px;" loading="lazy">
                        </picture>
                        <picture>
    ...
    <div class="container mb-5">
        ...
        <div class="row align-items-center my-4">
            <div class="ml-3 mr-5">
                <h5 class="text-primary">Price: <strong>IDR 2,000,000 / night</strong></h5>
            </div>
            <div>
